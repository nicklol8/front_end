   ...
   handleChange(event) {
    ...
    return(
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <label htmlFor= "img"/>
              <input type="text" name="image" value={this.state.image} placeholder="img" onChange={this.handleChange} />
              <label htmlFor= "address"/>
              <input type="text" name="address" value={this.state.address} placeholder="address" onChange={this.handleChange} />
              <label htmlFor= "theme"/>
              <input type="text" name="theme" value={this.state.theme} placeholder="theme" onChange={this.handleChange} />
              <label htmlFor= "menu"/>
              <input type="text" name="menu" value={this.state.menu} placeholder="menu" onChange={this.handleChange} />
              <label htmlFor= "phone"/>
